...
/*
  - The paddle (#) remains visible when the ball passes over.
  - The left wall is made of tiles that disappear on hit, awarding 1 point per tile.
*/
...
static int score = 0;
static int leftWall[2000]; // 1: tile present, 0: removed
